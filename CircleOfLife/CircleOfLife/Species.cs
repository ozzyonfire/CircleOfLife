...
namespace CircleOfLife
{
    public class Species
    {
        ...
        {
            tempCreatures.Add(new Creature(xPos+50, yPos-50, stats, random,this));
            tempCreatures.Add(new Creature(xPos + 50, yPos + 50, stats, random, this));
            tempCreatures.Add(new Creature(xPos - 50, yPos + 50, stats, random, this));
            tempCreatures.Add(new Creature(xPos - 50, yPos - 50, stats, random, this));
        }
        ...
        {
            creatures.Add(new Creature((short)parent.Position.X,(short)parent.Position.Y, stats, random,this));
        }
